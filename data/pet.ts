...
export async function addDogWalk(newDogWalk: NewDogWalk): Promise<DogWalk> {
  ...
  let query =
    'INSERT INTO dog_walk (pet_id, did_pee, did_poop) VALUES ($1, $2, $3)';
  let params = [petId, didPee, didPoop];
  if (walkedAt) {
    query =
      'INSERT INTO dog_walk (pet_id, did_pee, did_poop, walked_at) VALUES ($1, $2, $3, $4)';
...
export async function updateDogWalk(updatedDogWalk: DogWalk): Promise<DogWalk> {
